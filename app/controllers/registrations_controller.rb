class RegistrationsController < Devise::RegistrationsController
	 protected
	  ...
	  def account_update_params
	  	hashh=Digest::MD5.hexdigest(params[:user][:email])
	  	params[:user][:profilePicUrl]='https://www.gravatar.com/avatar/'+hashh
	    params.require(:user).permit(:FirstName, :LastName, :Contact, :email,:Gender,:password, :password_confirmation, :current_password,:profilePicUrl,:interests,:facebook,:linkedin,:twitter,:about,:profession,:profession_place,:country,:bornon)
	  end
